        ...
        {stats.map((item) => (
          ...
          >
            <div className="flex items-start justify-between">
              <SoftIconCard icon={item.icon} size={15} variant={item.variant} />
                  ...
                  <tbody>
                    {tickets.map((t) => (
                      ...
                      >
                        ...
                        <td>
                          <button className="btn btn-xs rounded-lg px-3">
                            View
                          </button>
                        </td>
                      </tr>
            ...
            <div className="mt-4 space-y-3">
              <div className="flex gap-3">
                ...
                <p className="text-xs text-base-content/70">
                  78% of your tickets were resolved within 24 hours.
                </p>
              </div>
              ...
              <div className="flex gap-3">
                ...
                <p className="text-xs text-base-content/70">
                  AI helped resolve 5 support requests.
                </p>
              </div>
            </div>
          </CardWithBlurBlob>
          ...
          <CardWithBlurBlob className="p-5" interactive={false}>
            ...
            <div className="mt-4 space-y-3">
              <button className="w-full text-left">
                ...
                <p className="text-[10px] text-base-content/50">Billing</p>
              </button>
              <button className="w-full text-left">
                <p className="text-xs font-medium">Slack integration setup</p>
                <p className="text-[10px] text-base-content/50">Integration</p>
              </button>
              <button className="w-full text-left">
                <p className="text-xs font-medium">Account recovery guide</p>
                <p className="text-[10px] text-base-content/50">Account</p>
              </button>
            </div>
          </CardWithBlurBlob>
          </div>
